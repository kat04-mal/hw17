...
public class App {
    public static void main(String[] args) {
        ...
        try {
            ...
            // Добавим ещё одно яблоко для демонстрации удаления дубликатов
            basket.addProduct(new SimpleProduct("Яблоко", 90));
            ...
            List<Product> removeProducts = basket.removeProductsByName("Яблоко");
            ...
            List<Product> emptyResult = basket.removeProductsByName("Несуществующий продукт");
